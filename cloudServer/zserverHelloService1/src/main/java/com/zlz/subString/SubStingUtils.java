...
public class SubStingUtils {
    ...
    public static String[] subStringToArray(String source, String sign) {
...
//            middlePart = source.substring(startIndex, endIndex);
    ...
    */
    public static String getTextWithP(String source,int lineNum){
        ...
        for (String ssTemp : ss1) {
            ...
            if (StringUtils.isNotBlank(noPStr)) {
                ...
                if (dest.length() > 15) {//超过15个字符,截取12位拼接‘...’
                    sb.append("<p>").append(dest.substring(0, 12)).append("...").append("</p>");
                } else {
                    sb.append("<p>").append(dest).append("</p>");
                }
                System.out.println(dest);
                countNum++;
                if (countNum != 0 && countNum == lineNum) {
                    break;
                }
            }
